...
```
Terminal mostrando el mensaje de bienvenida de MySQL
![ Terminal mostrando el mensaje de bienvenida de MySQL](conexio_sql.png)
...
![Resultado de SHOW TABLES;](resultado_show.png)
...
```
DESCRIBE world.country y RENAME Conitinent a Continent
![DESCRIBE world.country y RENAME Conitinent a Continent](ejecución_describe.png)
 
---
💡 Desafío 1: Creación de Tabla Adicional
Como parte del reto práctico, se creó la tabla city con columnas específicas para demostrar versatilidad en la definición de tablas:
SQL
...
```
Esto permite futura relación con country mediante joins.
---
...
```SHOW DATABASES;
```
world ya no aparece en la lista de bases de datos.
![world ya no aparece en la lista de bases de datos](eliminación_.png)
